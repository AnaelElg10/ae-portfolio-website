    ...
    <>
      ...
      <div className="lg:hidden">
        ...
        <button
          ...
          className="fixed top-4 right-4 z-50 w-14 h-14 bg-primary/90 backdrop-blur-sm border-2 border-primary rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-xl"
